...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `66.3µs` | `84.2µs` |
| [Day 2](./src/bin/02.rs) | `169.7µs` | `296.5µs` |
| [Day 3](./src/bin/03.rs) | `47.5µs` | `47.5µs` |
| [Day 4](./src/bin/04.rs) | `58.0ns` | `46.0ns` |
| [Day 5](./src/bin/05.rs) | `165.7µs` | `236.8µs` |
| [Day 6](./src/bin/06.rs) | `318.7µs` | `1.0s` |
| [Day 7](./src/bin/07.rs) | `2.9ms` | `532.6ms` |
| [Day 8](./src/bin/08.rs) | `45.4µs` | `136.8µs` |
| [Day 9](./src/bin/09.rs) | `169.6µs` | `144.3ms` |
| [Day 10](./src/bin/10.rs) | `1.0ms` | `436.5µs` |
| [Day 11](./src/bin/11.rs) | `97.6µs` | `5.1ms` |
| [Day 12](./src/bin/12.rs) | `63.7ms` | `67.1ms` |
| [Day 13](./src/bin/13.rs) | `66.4µs` | `65.9µs` |
| [Day 14](./src/bin/14.rs) | `47.3µs` | `396.4ms` |
